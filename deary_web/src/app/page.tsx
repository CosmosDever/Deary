...
export default function Page() {
  return (
    <main className="flex flex-col w-screen h-auto bg-[url('/image/gridbg.png')] font-mitr">
      <section>
        <div className='flex flex-col md:flex-row justify-center w-screen mt-5  gap-7 px-4 '> {/* section1 */}
          <div className='text-transparent bg-clip-text bg-gradient-to-r from-[#662DC0] to-[#A01790] mt-20 md:ml-[120px] text-center md:text-left'>
            <h1 className='text-[40px]  font-semibold'>How was your day?</h1> <br />
            <p className='text-[20px] ]'>Welcome to Deary</p>
            <p className='text-[20px] '>the safest place for your thoughts.</p>
            <p className='text-[20px]  text-[#212121]'>Let’s keep your memory and your mood!</p>
            <a href="/sign-in">
              <button className='bg-[#6C2BB8] w-[180px] md:w-[220px] rounded-[10px] p-2 text-[20px]  text-white border-black border-2 mb-2 shadow-[7px_6px_black] transition ease-in-out delay-130 hover:-translate-y-1 hover:scale-105 hover:bg-[#6429AA] duration-100 mt-[20px] md:mt-[30px]'>Get started</button>
            </a>
          </div>

          <div className='flex justify-center'>
            <img className='w-[240px] md:w-[480px] h-auto mt-7' src="image/rocket.png" />
          </div>
        </div>
        ...
        <div className='flex flex-col md:flex-row justify-center mt-10 gap-10 text-[#212121] px-4'> {/* section2 */}
          <div className='flex flex-row  bg-[#FDF9F2] p-7 rounded-[15px] border-4 border-[#363636]'>
            ...
            <div className='flex justify-center'>
              <img className='w-[150px] h-[190px]' src="image/pencil.png" />
            </div>
          </div>
          ...
          <div className='flex flex-row bg-[#FDF9F2] p-7 rounded-[15px] gap-5 border-4 border-[#363636]'>
            ...
            <div className='flex justify-center'>
              <img className='w-[140px] h-auto' src="image/smile2.png" />
            </div>
          </div>
        </div>

        <div className='w-screen'> {/* section3 */}
          <div className='flex flex-col justify-center items-center gap-[20px] md:gap-[40px] bg-[#FDF9F2] mt-10 border-y-4 border-[#363636] text-[#212121] p-7'>
            <div className='flex justify-center'>
              <img className='w-[140px] h-auto' src="image/private.png" />
            </div>
          ...
          <div className='flex flex-col justify-center items-center gap-[20px]  bg-[#FDF9F2] mt-10 border-y-4 border-[#363636] text-[#212121] p-7'>
            <div className='text-center text-[16px] '>
            ...
            <div className='flex justify-center'>
              <img className='w-[100px]  h-auto' src="image/key.png" />
            </div>
          </div>

          <div className='flex flex-col  justify-center items-center gap-[20px] md:gap-[40px] bg-[#FDF9F2] mt-10 border-y-4 border-[#363636] text-[#212121] p-7'>
            <div className='flex justify-center'>
              <img className='w-[120px]  h-auto' src="image/accesss.png" />
            </div>
            <div className='text-center text-[16px] '>
