...
function Section({
  ...
  return (
    <div className="flex flex-col w-full max-w-[1000px] h-auto bg-[#FFFFFF] bg-opacity-[20%] backdrop-blur-sm p-6 md:p-10 md:px-12 rounded-[30px] sm:rounded-[40px] md:rounded-[50px] shadow-[0_3px_10px_rgb(0,0,0,0.2)] mx-auto mt-[75px]">
