...
return (
    ...
    <div className="flex min-h-screen flex-col items-center p-10">
        <h1 className="text-[35px] sm:text-[40px] md:text-[45px] font-semibold  text-transparent bg-clip-text bg-gradient-to-r from-[#662DC0] to-[#A01790] ">How are you feeling?</h1>
        
        <div className="flex sm:flex-row items-center gap-5 text-[#212121] ">    
