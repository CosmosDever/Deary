    ...
    return (
        ...
        <nav className='top-0 w-screen inset-x-0  h-[75px] bg-[#363636] font-mitr '>
            <div className='    flex items-center justify-between h-[75px] '>
                <Link as={Link} to={"/"} className='flex flex-row items-center gap-2 text-white text-2xl font-semibold ml-6'><img  src='image/dearylogo.png' height='50px' width='50px' />Deary</Link>
